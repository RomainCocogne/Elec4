...
/*
    Creation et manipulation d'une base de donnee sql
    sous la forme d'un magasin avec des rayons et articles
*/
class Bazar {
 private:
    shared_ptr<sql::Connection> conn_;  // connection au serveur sql
    unique_ptr<sql::PreparedStatement> add_rayon_stmt_; // preparation de la commande d'ajout d'un rayon
 public:
    // connection au serveur et preparation des rayons
    ...
    // affiche les articles dont la quantitee est inferieur a n
    ...
    // supprime puis ajoute un rayon
    // facon simple de modifier la base de donnee, mais prend plus de temps qu'une modification ciblee
